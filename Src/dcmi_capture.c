 ...
 */
#define DCMI_DIAGNOSTICS APP_ENABLE_DCMI_DIAGNOSTICS
 ...
 */
#define DCMI_COLOR_DIAGNOSTICS APP_ENABLE_COLOR_DIAGNOSTICS
...
static volatile uint32_t g_dcmi_zone_min_r;
static volatile uint32_t g_dcmi_zone_max_r;
static volatile uint32_t g_dcmi_zone_spread_r;
static volatile uint32_t g_dcmi_zone_min_g;
static volatile uint32_t g_dcmi_zone_max_g;
static volatile uint32_t g_dcmi_zone_spread_g;
static volatile uint32_t g_dcmi_zone_min_b;
static volatile uint32_t g_dcmi_zone_max_b;
static volatile uint32_t g_dcmi_zone_spread_b;
...
uint32_t g_dcmi_led_zone_r[DCMI_LED_ZONE_COUNT];
uint32_t g_dcmi_led_zone_g[DCMI_LED_ZONE_COUNT];
uint32_t g_dcmi_led_zone_b[DCMI_LED_ZONE_COUNT];
