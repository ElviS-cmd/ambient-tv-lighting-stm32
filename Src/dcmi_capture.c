...
#elif DCMI_SOURCE_MODE == 3U
#define VIDEO_ACTIVE_WIDTH 720U
#define VIDEO_ACTIVE_HEIGHT 480U
#else
...
#define DCMI_CROP_TEST_FIXED_SYNC_COMBO 3U /* HSYNC high, VSYNC high */
...
/* Cheap per-zone summaries for tracing a solid white screen through capture
 * and smoothing. This deliberately leaves the per-pixel histogram disabled.
 */
#define DCMI_COLOR_DIAGNOSTICS 1U
/* Records the 256-color sequence generated by tools/rgb332_test.html. The
 * recorder waits for a black/red/black/white/black/red marker, so leaving it
 * enabled has no effect until the calibration sequence is deliberately run.
 */
#define DCMI_RGB332_CALIBRATION_RECORDER 0U
#define DCMI_RGB332_CALIBRATION_SLOT_MS 750U
#define DCMI_RGB332_CALIBRATION_SAMPLE_START_MS 125U
#define DCMI_RGB332_CALIBRATION_SAMPLE_END_MS 625U
...
static volatile uint32_t g_dcmi_dominant_byte;
static volatile uint32_t g_dcmi_dominant_byte_count;
static volatile uint32_t g_dcmi_dominant_byte_percent;
static volatile uint32_t g_dcmi_dominant_r;
static volatile uint32_t g_dcmi_dominant_g;
static volatile uint32_t g_dcmi_dominant_b;
static uint16_t dcmi_byte_histogram[256];
...
#if DCMI_RGB332_CALIBRATION_RECORDER
/* Calibration recorder states: 0..6 marker acquisition, 7 recording,
 * 8 complete. Arrays are indexed by the expected RGB332 byte.
 */
static volatile uint32_t g_dcmi_calibration_state;
static volatile uint32_t g_dcmi_calibration_active;
static volatile uint32_t g_dcmi_calibration_done;
static volatile uint32_t g_dcmi_calibration_expected_byte;
static volatile uint32_t g_dcmi_calibration_completed_count;
static volatile uint32_t g_dcmi_calibration_valid_count;
static volatile uint32_t g_dcmi_calibration_exact_count;
static volatile uint32_t g_dcmi_calibration_unstable_count;
static volatile uint32_t g_dcmi_calibration_collision_count;
static volatile uint32_t g_dcmi_calibration_observed[256];
static volatile uint32_t g_dcmi_calibration_observed_percent[256];
static volatile uint32_t g_dcmi_calibration_alternate[256];
static volatile uint32_t g_dcmi_calibration_alternate_percent[256];
static volatile uint32_t g_dcmi_calibration_sample_count[256];
static uint16_t dcmi_calibration_histogram[256];
static uint8_t dcmi_calibration_seen_observed[256];
static uint32_t dcmi_calibration_marker_since_ms;
static uint32_t dcmi_calibration_reset_since_ms;
static uint32_t dcmi_calibration_epoch_ms;
static uint32_t dcmi_calibration_current_slot;
static uint32_t dcmi_calibration_vote_count;
#endif
...
volatile uint32_t g_dcmi_zone_min_r;
volatile uint32_t g_dcmi_zone_max_r;
volatile uint32_t g_dcmi_zone_spread_r;
volatile uint32_t g_dcmi_zone_min_g;
volatile uint32_t g_dcmi_zone_max_g;
volatile uint32_t g_dcmi_zone_spread_g;
volatile uint32_t g_dcmi_zone_min_b;
volatile uint32_t g_dcmi_zone_max_b;
volatile uint32_t g_dcmi_zone_spread_b;
...
volatile uint32_t g_dcmi_top_first_r;
volatile uint32_t g_dcmi_top_first_g;
volatile uint32_t g_dcmi_top_first_b;
volatile uint32_t g_dcmi_top_mid_r;
volatile uint32_t g_dcmi_top_mid_g;
volatile uint32_t g_dcmi_top_mid_b;
volatile uint32_t g_dcmi_top_last_r;
volatile uint32_t g_dcmi_top_last_g;
volatile uint32_t g_dcmi_top_last_b;
#if DCMI_INCREMENTAL_PUBLISH
volatile uint32_t g_dcmi_top_raw_color_spread;
volatile uint32_t g_dcmi_top_raw_first_r;
volatile uint32_t g_dcmi_top_raw_first_g;
volatile uint32_t g_dcmi_top_raw_first_b;
volatile uint32_t g_dcmi_top_raw_mid_r;
volatile uint32_t g_dcmi_top_raw_mid_g;
volatile uint32_t g_dcmi_top_raw_mid_b;
volatile uint32_t g_dcmi_top_raw_last_r;
volatile uint32_t g_dcmi_top_raw_last_g;
volatile uint32_t g_dcmi_top_raw_last_b;
volatile uint32_t g_dcmi_top_first_samples;
volatile uint32_t g_dcmi_top_mid_samples;
volatile uint32_t g_dcmi_top_last_samples;
#endif
...
static uint32_t sync_wait_start_ms;
#endif
...
/* Cache geometry-to-zone mappings. Border dimensions change rarely, so the
 * expensive divisions run only after a geometry change instead of on every
 * capture. Byte entries are sufficient because the highest zone is 135.
 */
#if !DCMI_SIDE_HORIZONTAL_BANDS && !DCMI_BOTTOM_TIMED_BAND
static uint8_t horizontal_zone_map[2][VIDEO_ACTIVE_WIDTH];
static uint8_t side_row_zone_map[2][VIDEO_ACTIVE_HEIGHT];
static uint32_t horizontal_zone_map_width[2];
static uint32_t side_row_zone_map_height[2];
static const uint8_t *active_horizontal_zone_map;
static const uint8_t *active_side_row_zone_map;
#else
...
static void prepare_capture_zone_map(void);
#if DCMI_BORDER_ACTIVE
...
#if DCMI_RGB332_CALIBRATION_RECORDER
static void calibration_consume_sample(uint32_t dominant_byte,
                                       uint32_t dominant_percent);
#endif
#endif
...
static void current_capture_zone_bounds(uint32_t *zone_start,
                                        uint32_t *zone_end);
...
static void start_snapshot_dma(void);
#if !DCMI_CROP_TEST_MODE && !DCMI_PREARM_CAPTURE
static void begin_frame_boundary_wait(void);
static uint32_t poll_frame_boundary_wait(void);
#endif
...
#if !DCMI_CROP_TEST_MODE && !DCMI_PREARM_CAPTURE
    if (dcmi_status.state == DCMI_CAPTURE_WAIT_SYNC) {
        uint32_t sync_status = poll_frame_boundary_wait();
...
uint32_t DCMI_Capture_ConsumeLedUpdate(void)
{
    ...
    if (pending != 0U) {
        ...
        for (uint32_t zone = 0U; zone < DCMI_LED_ZONE_COUNT; zone++) {
            uint32_t r = g_dcmi_led_zone_r[zone];
            uint32_t g = g_dcmi_led_zone_g[zone];
            uint32_t b = g_dcmi_led_zone_b[zone];
        ...
        g_dcmi_zone_min_r = min_r;
        g_dcmi_zone_max_r = max_r;
        g_dcmi_zone_spread_r = max_r - min_r;
        g_dcmi_zone_min_g = min_g;
        g_dcmi_zone_max_g = max_g;
        g_dcmi_zone_spread_g = max_g - min_g;
        g_dcmi_zone_min_b = min_b;
        g_dcmi_zone_max_b = max_b;
        g_dcmi_zone_spread_b = max_b - min_b;
    }
#endif
...
#if DCMI_CROP_TEST_MODE
    /* The polarity sweep identified HIGH/HIGH as the only combination that
     * completes this crop. Hold that result fixed while measuring transport
     * reliability so invalid combinations cannot distort the success rate.
     */
    g_dcmi_crop_test_sync_combo = DCMI_CROP_TEST_FIXED_SYNC_COMBO;
...
#endif
#else
    begin_frame_boundary_wait();
    dcmi_status.state = DCMI_CAPTURE_WAIT_SYNC;
    g_dcmi_state = DCMI_CAPTURE_WAIT_SYNC;
    return;
#endif
...
static void begin_frame_boundary_wait(void)
{
    sync_wait_start_ms = HAL_GetTick();
...
/* Return 0 while waiting, 1 on VSYNC, or 2 on timeout. */
static uint32_t poll_frame_boundary_wait(void)
{
    uint32_t now = HAL_GetTick();

    if (__HAL_DCMI_GET_FLAG(&hdcmi, DCMI_FLAG_VSYNCRI) != 0U) {
        g_dcmi_sync_wait_ms = now - sync_wait_start_ms;
        g_dcmi_sync_wait_status = 1U;
    ...
    if ((now - sync_wait_start_ms) < DCMI_SYNC_WAIT_TIMEOUT_MS) {
        return 0U;
    }

    g_dcmi_sync_wait_ms = now - sync_wait_start_ms;
    g_dcmi_sync_wait_status = 0U;
    ...
    if (crop_width >= 4U && (crop_width % 4U) == 0U &&
        ...
        if (active_crop_index == DCMI_EDGE_TOP ||
            ...
            for (uint32_t i = 0U; i < words_to_analyze; i++) {
                ...
                accumulate_led_zone_sample(active_horizontal_zone_map[x],
                                           word & 0xFFU);
                accumulate_led_zone_sample(active_horizontal_zone_map[x + 1U],
                                           (word >> 8U) & 0xFFU);
                accumulate_led_zone_sample(active_horizontal_zone_map[x + 2U],
                                           (word >> 16U) & 0xFFU);
                accumulate_led_zone_sample(active_horizontal_zone_map[x + 3U],
                                           word >> 24U);
            ...
            uint32_t first_kept_word =
                active_crop_index == DCMI_EDGE_RIGHT ? 3U : 0U;
            uint32_t kept_word_end = first_kept_word + 4U;

            for (uint32_t i = 0U; i < words_to_analyze; i++) {
                if (row_word >= first_kept_word && row_word < kept_word_end) {
                    uint32_t word = dcmi_buffer[i];
                    uint32_t zone = active_side_row_zone_map[row];

                    accumulate_led_zone_sample(zone, word & 0xFFU);
                    accumulate_led_zone_sample(zone, (word >> 8U) & 0xFFU);
                    accumulate_led_zone_sample(zone, (word >> 16U) & 0xFFU);
                    accumulate_led_zone_sample(zone, word >> 24U);
                }
...
static void prepare_capture_zone_map(void)
{
    ...
    if (active_crop_index == DCMI_EDGE_TOP ||
        active_crop_index == DCMI_EDGE_BOTTOM) {
        uint32_t map_index =
            active_crop_index == DCMI_EDGE_TOP ? 0U : 1U;
        uint8_t *map = horizontal_zone_map[map_index];

        if (horizontal_zone_map_width[map_index] != active_crop_width) {
            uint32_t offset = edge_zone_offset(active_crop_index);

            for (uint32_t x = 0U; x < active_crop_width; x++) {
                map[x] = (uint8_t)(offset +
                    edge_local_zone(active_crop_index, x, 0U,
                                    active_crop_width, active_crop_height));
            }
            horizontal_zone_map_width[map_index] = active_crop_width;
        }
        active_horizontal_zone_map = map;
        return;
    }

    {
        uint32_t map_index =
            active_crop_index == DCMI_EDGE_RIGHT ? 0U : 1U;
        uint8_t *map = side_row_zone_map[map_index];

        if (side_row_zone_map_height[map_index] != active_crop_height) {
            uint32_t offset = edge_zone_offset(active_crop_index);

            for (uint32_t row = 0U; row < active_crop_height; row++) {
                map[row] = (uint8_t)(offset +
                    edge_local_zone(active_crop_index, 0U, row,
                                    active_crop_width, active_crop_height));
            }
            side_row_zone_map_height[map_index] = active_crop_height;
        }
        active_side_row_zone_map = map;
    }
#else
...
#if DCMI_DIAGNOSTICS
#if DCMI_RGB332_CALIBRATION_RECORDER
#define DCMI_CALIBRATION_MARKER_STABLE_MS 400U
#define DCMI_CALIBRATION_INVALID_BYTE 0xFFFFFFFFU

static uint32_t calibration_marker_matches(uint32_t state,
                                           uint32_t dominant_byte,
                                           uint32_t dominant_percent)
{
    if (dominant_percent < 90U) {
        return 0U;
    }

    if (state == 1U || state == 5U) {
        return dominant_byte == 224U ? 1U : 0U; /* full red */
    }
    if (state == 3U) {
        return dominant_byte == 253U || dominant_byte == 255U ? 1U : 0U;
    }
    return dominant_byte == 0U ? 1U : 0U;
}

static void calibration_clear_histogram(void)
{
    for (uint32_t sample = 0U; sample < 256U; sample++) {
        dcmi_calibration_histogram[sample] = 0U;
    }
    dcmi_calibration_vote_count = 0U;
}

static void calibration_begin(uint32_t now_ms)
{
    for (uint32_t expected = 0U; expected < 256U; expected++) {
        g_dcmi_calibration_observed[expected] = DCMI_CALIBRATION_INVALID_BYTE;
        g_dcmi_calibration_observed_percent[expected] = 0U;
        g_dcmi_calibration_alternate[expected] = DCMI_CALIBRATION_INVALID_BYTE;
        g_dcmi_calibration_alternate_percent[expected] = 0U;
        g_dcmi_calibration_sample_count[expected] = 0U;
    }

    calibration_clear_histogram();
    dcmi_calibration_epoch_ms = now_ms;
    dcmi_calibration_current_slot = 0U;
    dcmi_calibration_reset_since_ms = 0U;
    g_dcmi_calibration_state = 7U;
    g_dcmi_calibration_active = 1U;
    g_dcmi_calibration_done = 0U;
    g_dcmi_calibration_expected_byte = 0U;
    g_dcmi_calibration_completed_count = 0U;
    g_dcmi_calibration_valid_count = 0U;
    g_dcmi_calibration_exact_count = 0U;
    g_dcmi_calibration_unstable_count = 0U;
    g_dcmi_calibration_collision_count = 0U;
}

static void calibration_finalize_slot(uint32_t slot)
{
    uint32_t primary_byte = DCMI_CALIBRATION_INVALID_BYTE;
    uint32_t alternate_byte = DCMI_CALIBRATION_INVALID_BYTE;
    uint32_t primary_count = 0U;
    uint32_t alternate_count = 0U;
    ...
    for (uint32_t sample = 0U; sample < 256U; sample++) {
        uint32_t count = dcmi_calibration_histogram[sample];

        if (count > primary_count) {
            alternate_count = primary_count;
            alternate_byte = primary_byte;
            primary_count = count;
            primary_byte = sample;
        } else if (count > alternate_count) {
            alternate_count = count;
            alternate_byte = sample;
        }
    }

    g_dcmi_calibration_sample_count[slot] = dcmi_calibration_vote_count;
    if (dcmi_calibration_vote_count > 0U) {
        g_dcmi_calibration_observed[slot] = primary_byte;
        g_dcmi_calibration_observed_percent[slot] =
            (primary_count * 100U) / dcmi_calibration_vote_count;
        g_dcmi_calibration_alternate[slot] = alternate_byte;
        g_dcmi_calibration_alternate_percent[slot] =
            (alternate_count * 100U) / dcmi_calibration_vote_count;
    }
    g_dcmi_calibration_completed_count = slot + 1U;
}

static void calibration_summarize(void)
{
    uint32_t valid_count = 0U;
    uint32_t exact_count = 0U;
    uint32_t unstable_count = 0U;
    uint32_t collision_count = 0U;

    for (uint32_t observed = 0U; observed < 256U; observed++) {
        dcmi_calibration_seen_observed[observed] = 0U;
    }

    for (uint32_t expected = 0U; expected < 256U; expected++) {
        uint32_t observed = g_dcmi_calibration_observed[expected];
        ...
        if (g_dcmi_calibration_observed_percent[expected] < 80U) {
            unstable_count++;
        }
        if (dcmi_calibration_seen_observed[observed] != 0U) {
            collision_count++;
        } else {
            dcmi_calibration_seen_observed[observed] = 1U;
        }
    }

    g_dcmi_calibration_valid_count = valid_count;
    g_dcmi_calibration_exact_count = exact_count;
    g_dcmi_calibration_unstable_count = unstable_count;
    g_dcmi_calibration_collision_count = collision_count;
}
                                       ...
                                       uint32_t dominant_percent)
{
    ...
    if (g_dcmi_calibration_active == 0U) {
        /* A sustained full-green preamble resets marker acquisition. It does
         * not erase the previous arrays until a new run actually begins.
         */
        if (dominant_byte == 28U && dominant_percent >= 90U) {
            if (dcmi_calibration_reset_since_ms == 0U) {
                dcmi_calibration_reset_since_ms = now_ms;
            } else if ((now_ms - dcmi_calibration_reset_since_ms) >=
                       DCMI_CALIBRATION_MARKER_STABLE_MS) {
                g_dcmi_calibration_state = 0U;
                dcmi_calibration_marker_since_ms = 0U;
            }
            return;
        }
        dcmi_calibration_reset_since_ms = 0U;

        if (g_dcmi_calibration_state >= 8U) {
            return;
        }

        if (g_dcmi_calibration_state == 6U &&
            calibration_marker_matches(6U, dominant_byte,
                                       dominant_percent) != 0U) {
            /* The first black code follows the final red marker. Capturing
             * that transition gives the browser and MCU a shared epoch.
             */
            calibration_begin(now_ms);
            return;
        }

        if (calibration_marker_matches(g_dcmi_calibration_state,
                                       dominant_byte,
                                       dominant_percent) != 0U) {
            if (dcmi_calibration_marker_since_ms == 0U) {
                dcmi_calibration_marker_since_ms = now_ms;
            } else if ((now_ms - dcmi_calibration_marker_since_ms) >=
                       DCMI_CALIBRATION_MARKER_STABLE_MS) {
                g_dcmi_calibration_state++;
                dcmi_calibration_marker_since_ms = 0U;
            }
        } else {
            dcmi_calibration_marker_since_ms = 0U;
    ...
    uint32_t elapsed_ms = now_ms - dcmi_calibration_epoch_ms;
    uint32_t slot = elapsed_ms / DCMI_RGB332_CALIBRATION_SLOT_MS;
    uint32_t phase_ms = elapsed_ms % DCMI_RGB332_CALIBRATION_SLOT_MS;

    if (slot >= 256U) {
        calibration_finalize_slot(dcmi_calibration_current_slot);
        calibration_summarize();
        g_dcmi_calibration_active = 0U;
        g_dcmi_calibration_done = 1U;
        g_dcmi_calibration_state = 8U;
        g_dcmi_calibration_expected_byte = 256U;
        return;
    }

    if (slot != dcmi_calibration_current_slot) {
        calibration_finalize_slot(dcmi_calibration_current_slot);
        calibration_clear_histogram();
        dcmi_calibration_current_slot = slot;
        g_dcmi_calibration_expected_byte = slot;
    }

    if (phase_ms >= DCMI_RGB332_CALIBRATION_SAMPLE_START_MS &&
        phase_ms <= DCMI_RGB332_CALIBRATION_SAMPLE_END_MS &&
        dominant_percent >= 80U) {
        if (dcmi_calibration_histogram[dominant_byte] < 0xFFFFU) {
            dcmi_calibration_histogram[dominant_byte]++;
        }
        dcmi_calibration_vote_count++;
    }
}
#endif /* DCMI_RGB332_CALIBRATION_RECORDER */
...
static void analyze_buffer_diagnostics(uint32_t words_to_analyze)
{
    ...
    for (uint32_t i = 0U; i < words_to_analyze; i++) {
        ...
        for (uint32_t shift = 0U; shift < 32U; shift += 8U) {
            ...
            if (dcmi_byte_histogram[sample] < 0xFFFFU) {
                dcmi_byte_histogram[sample]++;
            }
    ...
    if (sample_count > 0U) {
        uint32_t dominant_byte = 0U;
        uint32_t dominant_count = 0U;

        for (uint32_t sample = 0U; sample < 256U; sample++) {
            if (dcmi_byte_histogram[sample] > dominant_count) {
                dominant_count = dcmi_byte_histogram[sample];
                dominant_byte = sample;
            }
        }

        g_dcmi_dominant_byte = dominant_byte;
        g_dcmi_dominant_byte_count = dominant_count;
        g_dcmi_dominant_byte_percent = (dominant_count * 100U) / sample_count;
        g_dcmi_dominant_r = rgb332_red_lut[dominant_byte];
        g_dcmi_dominant_g = rgb332_green_lut[dominant_byte];
        g_dcmi_dominant_b = rgb332_blue_lut[dominant_byte];
...
#if DCMI_RGB332_CALIBRATION_RECORDER
        calibration_consume_sample(dominant_byte,
                                   g_dcmi_dominant_byte_percent);
#endif
    } else {
        g_dcmi_dominant_byte = 0U;
        g_dcmi_dominant_byte_count = 0U;
        g_dcmi_dominant_byte_percent = 0U;
        g_dcmi_dominant_r = 0U;
        g_dcmi_dominant_g = 0U;
        g_dcmi_dominant_b = 0U;
                                        ...
                                        uint32_t *zone_end)
{
    ...
    if (active_crop_index == DCMI_EDGE_TOP) {
        start = DCMI_TOP_ZONE_OFFSET;
        end = DCMI_LEFT_ZONE_OFFSET;
    } else if (active_crop_index == DCMI_EDGE_BOTTOM) {
        start = DCMI_BOTTOM_ZONE_OFFSET;
        end = DCMI_LED_ZONE_COUNT;
    } else if (active_crop_index == DCMI_EDGE_RIGHT) {
        start = DCMI_RIGHT_ZONE_OFFSET;
        end = DCMI_TOP_ZONE_OFFSET;
    } else if (active_crop_index == DCMI_EDGE_LEFT) {
        start = DCMI_LEFT_ZONE_OFFSET;
        end = DCMI_BOTTOM_ZONE_OFFSET;
    }
...
static void clear_current_capture_zones(void)
{
    ...
    current_capture_zone_bounds(&zone_start, &zone_end);
    for (uint32_t zone_index = zone_start; zone_index < zone_end; zone_index++) {
